    ...
    <div className="balance">
      <div className="mainBalance">
        ...
        <div className="right">
          ...
          <RavenButton
            ...
            label="Withdraw"
            color="orange"
            className="btn-add-money btn-primary-orange"
          />
        </div>
      </div>
      ...
      <div className="details">
        <div className="withdrawn">
          <div className="left">{icons.wave}</div>
          <div className="right">
            <p>Withdrawn</p>
            <h2>NGN 0.00</h2>
          </div>
        ...
        <div className="pending">
          <div className="left icon">{icons.wave}</div>
          <div className="right">
            <p>Pending</p>
            <h2>NGN 0.00</h2>
          </div>
      ...
      >
        <div className="modal_content_wrapper">
          <div className="modal_title">
            ...
            <small>
              Add money to your Aprokopay wallet to allow buy informations.
            </small>
          </div>

          <div className="payment_details">
            <p className="note">
              Pls send the amount inputed below to the provided account details,
              we confirm and update your wallet balance in 20mins.
            </p>
      ...
      >
        <div className="modal_content_wrapper">
          ...
          <div className="payment_details">
            <p className="note">
              When you request a withdrawal you get the specified amount in your
              bank account on file in less than 24hrs
            </p>
          </div>
          <div className="amount_contain">
            <RavenInputField
