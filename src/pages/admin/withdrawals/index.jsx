    ...
    <DashboardLayout>
          ...
          <div className="table-wrap">
            <RavenTable headerList={headerList} action>
              {withdrawal?.map((chi, idx) => {
                const { amount, created_at, status, approved, user } = chi
                      ...
                      return (
                        <div className="action_contain">
                          ...
                          >
                            <span
                              onClick={() =>
                                setModal({ approve: true, content: chi })
                              }
                            >
                              Approve Withdrawal
                            </span>
                            <span
                              onClick={() =>
                                setModal({ status: true, content: chi })
                              }
                            >
                              Update Status
                            </span>
      ...
      >
        <ErrorModal
          ...
          smallText={`If you approve this withrawal request, this means you have agreed to pay the user the stipulated amount of ${formatNumWithCommaNaira(
            String(modal?.content?.amount)
      ...
      >
        <ErrorModal
          ...
          smallText={
            'Update the withrawal status from either pending, to processing or paid, be sure you have paid the user before marking as paid.'
          }
          onCancel={() =>
            setModal({
              view: false,
