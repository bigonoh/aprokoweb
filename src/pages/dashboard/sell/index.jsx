...
<div className="header">
  <h6>Post a new information</h6>
  <p>Share an information that you believe people would pay to get.</p>
  </div>
  ...
  <div className="post_body">
    ...
    <div className="input-container">
     <RavenInputField 
        ...
        name="description"
        placeholder={'e.g If you need to fix your sinks, drainage, etc i have the right perso...'}
    />
    </div>
    ...
    />
      ...
      <RavenInputField 
        ...
        className='select-react' 
        placeholder='Public'
        selectOption={[{label: 'Private', value: "private"}, {label: 'Public', value: 'public'}]}
        onChange={(e) => {
          setFormData({
            ...formData,
            status: e.value
    ...
    <div className="submit_btn">
      ...
      loading={loading}
      disabled={!formData.title || !formData.description || !formData.city || !formData.state || !formData.price}
