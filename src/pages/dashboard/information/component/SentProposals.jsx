...
import {  acceptRejectProposal, deleteProposal, getProposal, getSentProposal } from '../../../../redux/info'
...
const loggedIn = useSelector((state) => state.user)?.user
  ...
  useEffect(() => {
    ...
    dispatch(getSentProposal(payload))
  }, [page, refresh])
  ...
  const deleteInfo = async (id) => {
    ...
    let response = await dispatch(deleteProposal(payload))
...
{/* 
                            ...
                            <span
                              onClick={() =>
                                { chi.accepted ?  toast.info("You can't delete an already accepted proposal") : setModal({
                                  view: false,
                                  edit: false,
                                  delete: true,
                                  content: chi,
      ...
      >
        <ErrorModal
          bigText={'Delete this proposal'}
          smallText={
            'Are you sure you want to delete this proposal, delete this proposal will remove it from your list of proposals'
          }
          onCancel={() =>
            setModal({
              view: false,
